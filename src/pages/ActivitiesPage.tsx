...
export function ActivitiesPage() {
  ...
  useEffect(() => { void identityRepository.getDashboard().then((dashboard) => { setProjects(dashboard.ownedProjects as OwnedProject[]); setDonations(dashboard.donations); setMessage(""); }).catch((error) => setMessage(error instanceof Error ? error.message : "Unable to load activity")); }, []);
